...
rf_model <- train(factor(readmitted, labels = c("NO", "YES")) ~ ., data=trainData, method='rf', 
...
confusionMatrix(reference = factor(testData$readmitted, labels = c("NO", "YES")), 
                data = as.factor(predicted), mode='everything', positive='YES')
```
