...
catVars <- c("race", "gender", "max_glu_serum", "A1Cresult", "insulin", "change", "at_emergent", "at_elective", 
             "at_other", "dd_home", "dd_facility_transfer", "dd_other", "as_outpatient", "as_facility_transfer", "as_ed", 
             "as_other", "diag_1grp_Blood", "diag_1grp_Circulatory", 
             "diag_1grp_Diabetes", "diag_1grp_Digestive", 
             ...
             "diag_2grp_Diabetes", "diag_2grp_Digestive", 
